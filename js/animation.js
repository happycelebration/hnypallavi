...
const config = {
    name: "Pallavi", // actual name of the recipient (Mandatory)

    nickname: "Pallavi", // nickname(optional)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Wish You A Very Happy New Year 2025";
...
setTimeout(() => {
    window.location.href = "indexus.html"; // Replace with your target URL
}, 100000);
